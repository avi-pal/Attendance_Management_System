...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open("Attendance_Management_System/college_images/facialrecognition.png")
        ...
        #second image
        img1=Image.open("Attendance_Management_System/college_images/smart-attendance.jpg")
        ...
        #third image
        img2=Image.open("Attendance_Management_System/college_images/university.jpg")
        ...
        Left_frame.place(x=5,y=10,width=734,height=580)
        
        img_left=Image.open("Attendance_Management_System/college_images/AdobeStock_303989091.jpeg")
        ...
        dep_combo=ttk.Combobox(Current_course_frame,font=("times new roman",13,"bold"),width=20,state="read only")
        ...
        year_combo=ttk.Combobox(Current_course_frame,font=("times new roman",13,"bold"),width=20,state="read only")
        ...
        semester_combo=ttk.Combobox(Current_course_frame,font=("times new roman",13,"bold"),width=20,state="read only")
        ...
        Right_frame.place(x=745,y=10,width=723,height=580)

        img_right=Image.open("Attendance_Management_System/college_images/Student.jpg")
