...
class Student:
    def __init__(self,root):
        ...
        #third image
        img2=Image.open("college_images/university.jpg")
    ...
    def add_data(self):
       if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
          ...
          try:
            conn=mysql.connector.connect(host="localhost",username="root",password="ananyo2001",database="face_recognizer")
    ...
    def delete_data(self):
       if self.va_std_id.get()=="":
          ...
          try:
             delete=messagebox.askyesno("Student detelete","Do you want to delete this student data",parent=self.root)
             if delete>0:
                conn=mysql.connector.connect(host="localhost",username="root",password="ananyo2001",database="face_recognizer")
                my_cursor=conn.cursor()
    ...
    def generate_dataset(self):
       if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
          ...
          try:
            ...
            face_classifier=cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml") #changed
            ...
            messagebox.showinfo("Result","Generating dataset comppleted!!")
          except Exception as es:
             messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
